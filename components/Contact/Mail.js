...
function Mail() {
  ...
  if (state.succeeded) {
    return (
      <p className='bg-green-400 p-6 text-white text-center rounded'>
  ...
  return (
    <div className='my-6'>
      <form onSubmit={handleSubmit}>
        ...
        <button
          className='rounded-full bg-sky-500 hover:bg-sky-600 text-white font-semibold duration-300 transform-gpu py-3 px-10 text-lg '
          type='submit'
